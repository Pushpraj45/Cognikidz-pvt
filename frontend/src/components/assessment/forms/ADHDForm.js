...
const ADHDForm = () => {
  ...
  const [formData, setFormData] = useState({
    // Attention section
    attention: {
      difficultyFocusing: 1, // 1-5 scale: 1=Never, 5=Always
      easilyDistracted: 1,
      forgetfulActivities: 1,
      difficultyOrganizing: 1,
      avoidsMentalEffort: 1,
      losesThings: 1,
    },
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 pt-20 xs:pt-24 sm:pt-32 pb-8 xs:pb-12">
        <div className="max-w-5xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
          <button
            type="button"
            onClick={() => navigate('/assessment')}
            className="mb-4 xs:mb-6 flex items-center gap-2 px-3 xs:px-4 py-2 xs:py-2 bg-white/80 dark:bg-gray-800/80 border border-gray-200 dark:border-gray-700 rounded-lg xs:rounded-xl shadow-sm hover:bg-blue-50 dark:hover:bg-gray-700 transition-all text-blue-700 dark:text-blue-200 font-medium xs:font-semibold text-sm xs:text-base"
          >
            <svg
          ...
          >
            {/* Header Section */}
            <div className="bg-gradient-to-r from-primary to-primary-dark text-white p-4 xs:p-6 sm:p-8">
              <motion.div
              ...
              >
                ...
                <p className="text-blue-100 text-sm xs:text-base sm:text-lg">
            ...
            >
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6">
                <div className="flex items-start space-x-2 xs:space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-2 text-sm xs:text-base sm:text-lg">
                      Assessment Instructions
                    </h3>
                    <p className="text-xs xs:text-sm sm:text-base text-blue-800 dark:text-blue-200 leading-relaxed">
                      Rate each behavior based on how often it occurs. Consider the child's behavior
                      over the past 6 months. Your honest assessment will help provide the most
                      accurate evaluation.
                    </p>
                  </div>
                </div>
            ...
            <form onSubmit={handleSubmit} className="p-4 xs:p-6 sm:p-8">
              <div className="space-y-6 xs:space-y-8 sm:space-y-12">
                ...
                >
                  ...
                  <div className="grid gap-4 xs:gap-6 sm:gap-8">
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('attention', 'difficultyFocusing')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('attention', 'easilyDistracted')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('attention', 'forgetfulActivities')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('attention', 'difficultyOrganizing')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('attention', 'avoidsMentalEffort')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('attention', 'losesThings')}
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="grid gap-4 xs:gap-6 sm:gap-8">
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('hyperactivity', 'fidgets')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('hyperactivity', 'leavesSeating')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('hyperactivity', 'restlessness')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('hyperactivity', 'difficultyQuietPlay')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('hyperactivity', 'onTheGo')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('hyperactivity', 'talksTooMuch')}
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center space-x-2 xs:space-x-3 mb-4 xs:mb-6">
                    <div className="w-10 h-10 xs:w-12 xs:h-12 bg-gradient-to-br from-red-400 to-red-600 rounded-lg xs:rounded-xl flex items-center justify-center">
                      <svg
                        className="w-5 h-5 xs:w-6 xs:h-6 text-white"
                        fill="none"
                        stroke="currentColor"
                  ...
                  <div className="grid gap-4 xs:gap-6 sm:gap-8">
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('impulsivity', 'blurtsOutAnswers')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('impulsivity', 'difficultWaitingTurn')}
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-6 border border-gray-200/50 dark:border-gray-600/50">
                      ...
                      {renderRadioOptions('impulsivity', 'interruptsOthers')}
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="w-full sm:w-auto px-6 xs:px-8 py-3 xs:py-4 bg-gradient-to-r from-primary via-blue-600 to-indigo-600 hover:from-primary-dark hover:via-blue-700 hover:to-indigo-700 text-white rounded-lg xs:rounded-2xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed font-medium xs:font-semibold text-base xs:text-lg shadow-xl shadow-primary/25 hover:shadow-2xl hover:shadow-primary/40 flex items-center justify-center space-x-2 xs:space-x-3 group min-h-[48px] xs:min-h-[52px]"
                  >
                    <AnimatePresence>
                      {isSubmitting && (
                        <motion.div
                    ...
                    <span className="flex items-center gap-1 xs:gap-2">
                      {isSubmitting ? 'Starting Assessment...' : 'Start ADHD Assessment'}
                      {!isSubmitting && (
                        <svg
      ...
      {isSubmitting && (
        <div className="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center z-50 p-4">
          <AssessmentLoader
            message="Starting ADHD assessment..."
